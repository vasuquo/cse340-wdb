...
CREATE TYPE public.payment_method AS ENUM ('Card', 'Bank_transfer', 'Wallet');
CREATE TYPE public.payment_status AS ENUM ('Pending', 'Success', 'Failed');
ALTER TYPE public.account_type OWNER TO cse340db;
ALTER TYPE public.booking_status OWNER TO cse340db;
ALTER TYPE public.payment_method OWNER TO cse340db;
ALTER TYPE public.payment_status OWNER TO cse340db;
...
CREATE TABLE IF NOT EXISTS public.bookings (
    ...
    booking_status booking_status NOT NULL DEFAULT 'Pending'::booking_status,
    booking_period NUMERIC(9, 0) NOT NULL,
    booking_amount NUMERIC(9, 0) NOT NULL,
...
ALTER TABLE IF EXISTS public.bookings
ADD CONSTRAINT fk_service FOREIGN KEY (service_id) REFERENCES public.service_rates (service_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;
ALTER TABLE IF EXISTS public.bookings
...
CREATE TABLE IF NOT EXISTS public.payments (
    ...
    payment_amount NUMERIC(9, 0) NOT NULL,
    payment_method payment_method NOT NULL DEFAULT 'Wallet'::payment_method,
...
ADD CONSTRAINT fk_bookings FOREIGN KEY (booking_id) REFERENCES public.bookings (booking_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;
CREATE TABLE IF NOT EXISTS public.service_rates (
    service_id INTEGER NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    service_type VARCHAR(50) NOT NULL,
    service_description TEXT NOT NULL,
    service_rate NUMERIC(9, 0) NOT NULL,
    CONSTRAINT service_pkey PRIMARY KEY (service_id)
);
INSERT INTO public.service_rates (service_type, service_description, service_rate)
VALUES (
        'City Tour',
        'Guided city exploration tour',
        15000
    ),
    (
        'Adventure Tour',
    ...
    (
        ...
        'omfortable 4-seater car',
        18000
    ),
    (
        'Vehicle Rental - SUV',
        'Spacious 7-seater vehicle',
        30000
    ),
    (
    ...
    (
        'Tour Guide Service - Local',
        'Professional local tour guide',
        12000
    ),
    (
        'Tour Guide Service - Private',
        'Exclusive personal guide',
        25000
    );
